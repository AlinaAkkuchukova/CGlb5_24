...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Texture/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/2.jpg");
        ...
        return m_pMesh->LoadMesh("C:/Texture/phoenix_ugv.md2");
    }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Tutorial 24")) {
        return 1;
    }
